...
# Specify file name
fname = "data/200420COVID19MEXICO.csv"
...
os.mkdir(out_dir)
c = run(y='deaths', fname=fname, name='Y', out_dir=out_dir, waiting=False, add_vars=['RESULTADO','TIPO_PACIENTE','NEUMONIA', 'INTUBADO', 'UCI'])
coeff_LC.extend(c)
c = run(y='deaths', fname=fname, name='Y-W', out_dir=out_dir, waiting=True, add_vars=['RESULTADO','TIPO_PACIENTE','NEUMONIA', 'INTUBADO', 'UCI'])
coeff_LC.extend(c)
...
#TODO: add information about the weights logit
#TODO: summary of dataset
#TODO: divide age by max(age)